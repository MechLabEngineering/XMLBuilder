...
#include "../../XML_Builder/StartWidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_StartWidget_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_StartWidget_t qt_meta_stringdata_StartWidget = {
    {
...
const QMetaObject StartWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_StartWidget.data,
      qt_meta_data_StartWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_StartWidget.stringdata))
